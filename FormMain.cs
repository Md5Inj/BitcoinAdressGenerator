    ...
    public partial class FormMain : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                File.WriteAllText(filePath.Trim(), sb.ToString());
        ...
        private void buttonOpen_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                textBoxText.Text=System.IO.File.ReadAllText(filePath.Trim());
        ...
        private void buttonSelectFile_Click(object sender, EventArgs e)
        {
            ...
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                ...
                this.Text = "Генератор адресов биткоина - " + Path.GetFileName(filePath);
                StatusMessage("Загружено строк: " + File.ReadLines(filePath).Count());
            }
        }
